...
const endpoints = {
    allItems: "/data/shoes?sortBy=_createdOn%20desc", // from word document url
    items: "/data/shoes" // from word document url
}
...
export async function searchItem(query) {
    return await get(`${endpoints.items}?where=brand%20LIKE%20%22${query}%22`)
}
