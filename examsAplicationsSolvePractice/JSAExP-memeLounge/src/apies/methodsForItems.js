...
const endpoints = {
    allItems: "/data/memes?sortBy=_createdOn%20desc", // from word document url
    items: "/data/memes", // from word document url
    getMyPost: (userId) => `/data/memes?where=_ownerId%3D%22${userId}%22&sortBy=_createdOn%20desc`
}
