...
const endpoints = {
    allItems: "/data/books?sortBy=_createdOn%20desc", // from word document url
    
    items: "/data/books", // from word document url
    getMyPost: (userId) => `/data/books?where=_ownerId%3D%22${userId}%22&sortBy=_createdOn%20desc`
}
